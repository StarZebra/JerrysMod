...
public class OutlineUtils {
	...
	public static void outlineEntity(ModelBase model, Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scaleFactor, Color color) {
		boolean fancyGraphics = JerrysMod.mc.gameSettings.fancyGraphics;
		float gamma = JerrysMod.mc.gameSettings.gammaSetting;
		JerrysMod.mc.gameSettings.fancyGraphics = false;
		JerrysMod.mc.gameSettings.gammaSetting = Float.MAX_VALUE;
		...
		JerrysMod.mc.gameSettings.fancyGraphics = fancyGraphics;
		JerrysMod.mc.gameSettings.gammaSetting = gamma;
	}
	...
	private static void setupFBO(Framebuffer fbo) {
		...
		EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, JerrysMod.mc.displayWidth, JerrysMod.mc.displayHeight);
